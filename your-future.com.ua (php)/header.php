    ...
    <div class="navigationPage">
        ...
        <nav>
            <ul class="b-nav">
                ...
                <li><a class="b-link" href="projects.php">Проекти </a></li>
                <li>
                    <a class="b-link " href="#">Звітність</a>
                    <ul class="b-nav">
                        <li><a class="b-link" href="reviews.php" >Відгуки</a></li>
                        <li><a class="b-link" href="video-reporting.php" >Відео </a></li>
                        <li><a class="b-link" href="photo-reporting.php" >Фотозвітність </a></li>
